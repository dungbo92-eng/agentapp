...
| `docs/dashboard-control-surface.md` | 통합 콘솔 UX, 계정 별칭, 프로젝트 등록, Start/Stop 기준 |
...
pnpm agent:setup     # Node/Git/pnpm/AI CLI 설치 및 PATH 점검
pnpm agent:cycle-test # dashboard 실행 한 사이클 라우팅 점검
...
dashboard 통합 콘솔 기준은 `docs/dashboard-control-surface.md`를 따른다. 계정 연결은 비밀값 없는 user-managed 별칭/예산 등록이고, 프로젝트 등록과 Start/Stop UX는 로컬 실행 API로 확장한다.
