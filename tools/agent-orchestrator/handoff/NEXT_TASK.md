...
- Generated: 2026-05-09T10:53:54.894Z
- Selected task: `RUN_STATUS.md` 템플릿 확정
...
1. `RUN_STATUS.md` 템플릿 확정.
2. `DECISIONS_REQUIRED.md` 템플릿 확정.
3. 작업 종료 시 memory/plan/handoff 갱신 규칙 정리.
4. roadmap 체크박스 기반 진행률 계산 고도화.
5. Codex/Claude/Cursor/Gemini 각각의 수동 실행 프롬프트 템플릿 작성.
