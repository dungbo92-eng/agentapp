...
- Generated: 2026-05-09T12:45:10.728Z
- Selected task: 작업 종료 시 memory/plan/handoff 갱신 규칙 정리
...
1. 작업 종료 시 memory/plan/handoff 갱신 규칙 정리.
2. 계정 수/요금제/남은 주간 사용량 설정 스키마 작성.
3. 작업 난이도별 모델 추천 CLI 초안 작성.
4. roadmap 체크박스 기반 진행률 계산 고도화.
5. `agent-next`가 우선순위/의존성/보류 상태를 반영하도록 개선.
