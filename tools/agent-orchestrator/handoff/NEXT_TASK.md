...
- Generated: 2026-05-09T13:11:24.457Z
- Selected task: `agent-report`가 project_state까지 갱신하도록 개선
- Selection source: task-queue
- Task id: agent-report-project-state
- Task priority: 65
...
1. `agent-report`가 project_state까지 갱신하도록 개선.
2. 안전 작업/보류 작업을 분류하는 dry-run 명령 추가.
3. worker별 프롬프트 템플릿 생성 명령 추가.
4. Codex 작업 프롬프트 생성 어댑터.
5. Claude Code 작업 프롬프트 생성 어댑터.
