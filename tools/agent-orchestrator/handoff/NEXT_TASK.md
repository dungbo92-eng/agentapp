...
- Generated: 2026-05-09T12:50:52.098Z
- Selected task: `agent-next`가 우선순위/의존성/보류 상태를 반영하도록 개선
...
4. `agent-next`가 우선순위/의존성/보류 상태를 반영하도록 개선.
5. `agent-progress`가 phase별 진행률을 출력하도록 개선.
