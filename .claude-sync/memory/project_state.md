...
- Updated: 2026-05-11T09:06:32.013Z
- Status: completed
- Summary: Packaged Electron에서 dashboard worker 실행 시 AgentApp.exe를 다시 spawn하지 않고 main process 내부 백그라운드 실행으로 전환해 설치 경로 누락 시 main process JS 오류가 뜨는 문제를 수정했습니다. 최신 installer로 설치 경로도 복구했습니다.
- Verification: pnpm validate; pnpm desktop:installer; pnpm desktop:pack; installer /S reinstall exit 0; installed AgentApp.exe 8초 생존; pnpm desktop:artifact
- Git: not recorded
- Decisions: none
